export const site = {
  ...
  description:
    "Granny's Daycare Center in Shell Obili, Yaoundé offers a safe, loving and nurturing environment where children learn, play and grow. Flexible full-day, half-day and weekly childcare plans.",
